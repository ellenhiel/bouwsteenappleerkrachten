            ...
            <table class="leerlingen lopende" style="border-radius: 4px; width: 100%;">
                ...
                <th colspan="3"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17">
                  <g id="Polygon_1" data-name="Polygon 1" transform="translate(20 17) rotate(180)">
                    <path d="M 19.12578964233398 16.5 L 0.8742111921310425 16.5 L 10 0.9861590266227722 L 19.12578964233398 16.5 Z" stroke="none"/>
                    <path d="M 10 1.97230052947998 L 1.7484130859375 16 L 18.2515869140625 16 L 10 1.97230052947998 M 10 0 L 20 17 L 0 17 L 10 0 Z" stroke="none" fill="#707070"/>
                  </g>
                </svg></a> Lopende opdrachten</th>
                <th colspan="1"><a href="opdracht_toevoegen.php" class="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="22.5" height="22.5" viewBox="0 0 22.5 22.5">
                ...
                <tr>
                    ...
                    <td>tg. 12/01/2022</td>
                    <td><a href="opdracht_beoordelen.php" class="btn_no_style" style="margin: 0;"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="28.5" viewBox="0 0 30 28.5">
                        <g id="Group_1" data-name="Group 1" transform="translate(-1462.5 -343.75)">
                          <path id="Icon_material-grade" data-name="Icon material-grade" d="M7.215,25.905,3,12.945,7.215,3l4.215,9.945,10.785.915-8.19,7.1L16.485,31.5Z" transform="translate(1470.285 340.75)"/>
                          <path id="Icon_material-grade-2" data-name="Icon material-grade" d="M33,25.905,23.73,31.5l2.46-10.545L18,13.86l10.785-.915Z" transform="translate(1444.5 340.75)" fill="#ffd706"/>
                        </g>
                      </svg><span>beoordeel</span></a></td>
                    <td><a href="opdracht_aanpassen.php" class="btn_no_style" style="margin: 0;"><svg xmlns="http://www.w3.org/2000/svg" width="24.657" height="23.6" viewBox="0 0 24.657 23.6">
                        <g id="Icon_feather-edit-3" data-name="Icon feather-edit-3" transform="translate(-3 -2.818)">
                          <path id="Path_3" data-name="Path 3" d="M18,30H28.829" transform="translate(-2.671 -5.082)" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/>
                          <path id="Path_4" data-name="Path 4" d="M20.743,5.066a2.552,2.552,0,1,1,3.61,3.61L9.313,23.715,4.5,24.918l1.2-4.813Z" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/>
                        </g>
