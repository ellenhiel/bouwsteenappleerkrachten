...
<body>
    <nav>
        ...
        <a href="opdrachten.php?class_id=<?php echo $_GET['class_id']; ?>" style="background-color: #F6F6F6; color: #16AC9C;">Opdrachten</a>
        <a href="leerlingen.php?class_id=<?php echo $_GET['class_id']; ?>">Leerlingen</a>
    ...
    <section>
        ...
        <form action="#" method="POST" id="opdrachtform" enctype="multipart/form-data" onsubmit="opdrachtAanpassen(event)">
            ...
            <div>
                ...
                <input type="text" value="<?php echo $assignment['name']; ?>" name="titel" placeholder="Titel van de opdracht">
            </div>

            <div>
                <p><label for="beschrijving">Beschrijving:</label></p>
                <input type="text" value="<?php echo $assignment['description'] ?>" class="beschrijving" name="beschrijving" placeholder="Beschrijving van de opdracht">
            </div>
