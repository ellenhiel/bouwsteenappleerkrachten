...
<?php
    ...
    $assignmentsdoneid = User::getIdStudentsAssignmentByStudentsId($student_id, 1);
    $assignmentsnotdoneid = User::getIdStudentsAssignmentByStudentsId($student_id, 0);
...
<body>
    ...
    <section>
        ...
        <table>
            ...
            <col style="width: 5%;">
            <tr>
                <td><h1><?php echo $student['surname'] . ' ' . $student['name']; ?></h1></td>
        ...
        <table class="leerlingen" style="border-radius: 4px; width: 100%;">
            ...
            <tr>
                <td>
                Er zijn geen voltooide opdrachten gevonden.
                </td>
            </tr>
            <?php endif; ?>
        </table>
        ...
        <table class="leerlingen" style="border-radius: 4px; width: 100%;">
            ...
            <tr>
                <td>
                Er zijn geen onvoltooide opdrachten gevonden.
                </td>
            </tr>
            <?php endif; ?>
        </table>
