    ...
    <section>
        ...
        <div class="leerlingen">
            ...
            <table>
                ...
                <tr>
                    <td><p>Stijn Bouckaert</p></td>
                    <td><img src="images/avatar.png" alt="avatar"></td>
                    <td><a class="btn tda" href="leerling_opdrachten.php">opdrachten</a></td>
                    <td><img src="images/munt.png" alt="coin">50</td>
                    <td><svg id="Icon_material-tag-faces" data-name="Icon material-tag-faces" xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
                        <path id="Icon_material-tag-faces-2" data-name="Icon material-tag-faces" d="M24.978,3A22,22,0,1,0,47,25,21.989,21.989,0,0,0,24.978,3ZM25,42.6A17.6,17.6,0,1,1,42.6,25,17.6,17.6,0,0,1,25,42.6Zm7.7-19.8a3.3,3.3,0,1,0-3.3-3.3A3.3,3.3,0,0,0,32.7,22.8Zm-15.4,0A3.3,3.3,0,1,0,14,19.5,3.3,3.3,0,0,0,17.3,22.8ZM25,37.1a12.092,12.092,0,0,0,11.242-7.7H13.758A12.092,12.092,0,0,0,25,37.1Z" transform="translate(-3 -3)" fill="#21d24b"/>
                      </svg><p>Het is leuk in de klas</p></td>
                </tr>
                <tr>
                    <td><p>Deborah Baeten</p></td>
                    <td><img src="images/avatar.png" alt="avatar"></td>
                    <td><a class="btn tda" href="#">opdrachten</a></td>
                    <td><img src="images/munt.png" alt="coin">60</td>
                    <td><svg id="Icon_material-tag-faces" data-name="Icon material-tag-faces" xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
                        <path id="Icon_material-tag-faces-2" data-name="Icon material-tag-faces" d="M24.978,3A22,22,0,1,0,47,25,21.989,21.989,0,0,0,24.978,3ZM25,42.6A17.6,17.6,0,1,1,42.6,25,17.6,17.6,0,0,1,25,42.6Zm7.7-19.8a3.3,3.3,0,1,0-3.3-3.3A3.3,3.3,0,0,0,32.7,22.8Zm-15.4,0A3.3,3.3,0,1,0,14,19.5,3.3,3.3,0,0,0,17.3,22.8ZM25,37.1a12.092,12.092,0,0,0,11.242-7.7H13.758A12.092,12.092,0,0,0,25,37.1Z" transform="translate(-3 -3)" fill="#21d24b"/>
                      </svg><p>Ik zit niet graag naast Ellen</p></td>
                </tr>
                <tr>
                    <td><p>Ellen Hiel</p></td>
                    <td><img src="images/avatar.png" alt="avatar"></td>
                    <td><a class="btn tda" href="#">opdrachten</a></td>
                    <td><img src="images/munt.png" alt="coin">10</td>
                    <td><svg id="Icon_material-tag-faces" data-name="Icon material-tag-faces" xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
                        <path id="Icon_material-tag-faces-2" data-name="Icon material-tag-faces" d="M24.978,3A22,22,0,1,0,47,25,21.989,21.989,0,0,0,24.978,3ZM25,42.6A17.6,17.6,0,1,1,42.6,25,17.6,17.6,0,0,1,25,42.6Zm7.7-19.8a3.3,3.3,0,1,0-3.3-3.3A3.3,3.3,0,0,0,32.7,22.8Zm-15.4,0A3.3,3.3,0,1,0,14,19.5,3.3,3.3,0,0,0,17.3,22.8ZM25,37.1a12.092,12.092,0,0,0,11.242-7.7H13.758A12.092,12.092,0,0,0,25,37.1Z" transform="translate(-3 -3)" fill="#21d24b"/>
                      </svg></td>
                </tr>
                <tr>
                    <td><p>Bailey Lievens</p></td>
                    <td><img src="images/avatar.png" alt="avatar"></td>
                    <td><a class="btn tda" href="#">opdrachten</a></td>
                    <td><img src="images/munt.png" alt="coin">50</td>
                    <td><svg id="Icon_material-tag-faces" data-name="Icon material-tag-faces" xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
                ...
                <tr>
                    <td><p>Ilya Plyusnin</p></td>
                    <td><img src="images/avatar.png" alt="avatar"></td>
                    <td><a class="btn tda" href="#">opdrachten</a></td>
                    <td><img src="images/munt.png" alt="coin">40</td>
                    <td><svg id="Icon_material-tag-faces" data-name="Icon material-tag-faces" xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
                        <path id="Icon_material-tag-faces-2" data-name="Icon material-tag-faces" d="M24.978,3A22,22,0,1,0,47,25,21.989,21.989,0,0,0,24.978,3ZM25,42.6A17.6,17.6,0,1,1,42.6,25,17.6,17.6,0,0,1,25,42.6Zm7.7-19.8a3.3,3.3,0,1,0-3.3-3.3A3.3,3.3,0,0,0,32.7,22.8Zm-15.4,0A3.3,3.3,0,1,0,14,19.5,3.3,3.3,0,0,0,17.3,22.8ZM25,37.1a12.092,12.092,0,0,0,11.242-7.7H13.758A12.092,12.092,0,0,0,25,37.1Z" transform="translate(-3 -3)" fill="#21d24b"/>
                      </svg></td>
                </tr>
                <tr>
                    <td><p>Nick Bevers</p></td>
                    <td><img src="images/avatar.png" alt="avatar"></td>
                    <td><a class="btn tda" href="#">opdrachten</a></td>
                    <td><img src="images/munt.png" alt="coin">30</td>
                    <td><svg id="Icon_material-tag-faces" data-name="Icon material-tag-faces" xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
                        <path id="Icon_material-tag-faces-2" data-name="Icon material-tag-faces" d="M24.978,3A22,22,0,1,0,47,25,21.989,21.989,0,0,0,24.978,3ZM25,42.6A17.6,17.6,0,1,1,42.6,25,17.6,17.6,0,0,1,25,42.6Zm7.7-19.8a3.3,3.3,0,1,0-3.3-3.3A3.3,3.3,0,0,0,32.7,22.8Zm-15.4,0A3.3,3.3,0,1,0,14,19.5,3.3,3.3,0,0,0,17.3,22.8ZM25,37.1a12.092,12.092,0,0,0,11.242-7.7H13.758A12.092,12.092,0,0,0,25,37.1Z" transform="translate(-3 -3)" fill="#21d24b"/>
                    </svg></td>
                </tr>
