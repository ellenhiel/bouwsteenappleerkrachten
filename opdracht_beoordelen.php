...
<body>
    ...
    <section>
        <a class="btn_no_style arrow_back" href="javascript:history.back()"><svg xmlns="http://www.w3.org/2000/svg" width="7.5"
            ...
            </svg> <?php echo $subject; ?></a>
        
        <div class="div">
            <h2>Opdracht beoordelen</h2>
        <div class="opdracht">
            <p><?php echo $assignment['name']; ?></p>
            <img src="images/munt.png" alt="munt">
            <p><?php echo $assignment['reward']; ?></p>
        </div>
    </div>
    <form action="#" method="POST" enctype="multipart/form-data" onsubmit="opdrachtBeoordelen(event)">
        <table class="leerlingen">
            <col style="width: 20%;">
            <col style="width: 20%;">
            <col style="width: 50%;">
            <col style="width: 10%;">
        ...
        <div class="div">
            <button type="submit" class="btn">Valideer</button>
        </div>
        </form>
    </section>
