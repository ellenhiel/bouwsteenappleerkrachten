...
<?php
    ...
    $subject = User::getSubjectById(htmlspecialchars($_GET['subject_id']))['name'];
    $assignment = User::getAssignmentById($assignment_id)[0];
    $className = User::getClassById(htmlspecialchars($_GET['class_id']));
...
<head>
    ...
    <link rel="stylesheet" href="css/opdracht_bekijken.css">
    <title>Opdracht bekijken</title>
...
<body>
    ...
    <section>
        ...
        <table>
            <col style="width: 50%;">
            <col style="width: 50%;">
            <th colspan="2" style="text-align: left;"><h1><?php echo $assignment['name']; ?></h1></th>
            <tr>
                <td>Klas:</td>
